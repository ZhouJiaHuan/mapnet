...
@LOSSES.register_module(name='QuaternionLoss')
...
@LOSSES.register_module(name='PoseNetCriterion')
...
@LOSSES.register_module(name='MapNetCriterion')
...
@LOSSES.register_module(name='MapNetOnlineCriterion')
