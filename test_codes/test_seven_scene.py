...
from mapnet.datasets import SevenScenes
...
seven_scene = SevenScenes(scene=scene, data_path=data_path,
                          train=True, transform=data_transform,
                          target_transform=target_transform)

data_loader = DataLoader(seven_scene, batch_size=128, shuffle=True,
