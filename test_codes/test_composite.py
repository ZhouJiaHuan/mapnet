...
from mapnet.datasets import MF
...
mf_dataset = MF(dataset, scene=scene, data_path=data_path,
                train=True, transform=data_transform,
                target_transform=target_transform, steps=3, skip=10)

data_loader = DataLoader(mf_dataset, batch_size=128, shuffle=True,
